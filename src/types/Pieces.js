...
const fs = require('../torrent-parser.js');
...
module.exports = class {
    constructor(torrent) {
        function buildPiecesArray() {
            ...
            return arr.map((_, i) => {
                let bpp = fs.blocksPerPiece(torrent, i);
                if(Number.isNaN(bpp)) bpp = 1;
                Array(bpp).fill(false)
            });
        }
    ...
    addRequested(pieceBlock) {
        const blockIndex = pieceBlock.begin / fs.BLOCK_LEN;
